...
@onready var _mesh: MeshInstance3D = $FadeMesh
...
# Set the fade level
func set_fade_level(p_color : Color) -> void:
	_material.set_shader_parameter("albedo", p_color)
	_mesh.visible = p_color.a > 0
	visible = _mesh.visible
