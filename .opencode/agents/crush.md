---
description: Default development agent with full tool access for coding tasks
mode: primary
color: "#e056e3"
permission:
  edit: allow
...
7. **PERSIST IMPORTANT INFORMATION**: If some information seems important and isn't documents in any instructions. Verify by the user to add it at an appropriate place.
...
- Test command → check package.json
